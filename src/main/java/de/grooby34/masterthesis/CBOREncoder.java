 ...
 *
 * <p>Lightweight CBOR encoder specifically designed for CTAP2 protocol responses on JavaCard
 * platforms with memory constraints.
 *
 * <p>Features: - FIDO2-specific response encoding methods - Memory-efficient encoding without
 * dynamic allocation - Support for all CBOR major types needed for CTAP2 responses - Optimized for
 * attestation objects and assertion responses
 *
...
public class CBOREncoder {
   ...
   */
  public void encodeAssertionResponse(
      byte[] credentialId,
      byte[] authData,
